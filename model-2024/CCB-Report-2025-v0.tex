...
Reprocessing for detector data is assumed to happen every year and cover \configPDHDReprocess\ years for protodune and the whole sample for the FD and ND.

New simulation is assumed to happen every year and previous years are not reprocessed. 

Copies of data are kept on disk with the following lifetimes and number of copies:
...
\label{tab:DetectorParameters}
\end{table}


 \subsection{Resource split assumptions}
