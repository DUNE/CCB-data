...
\input{NearTerm_2024-09-03-2030_noMWC/NearTerm_2024-09-03-2040macros.tex}
\makeatletter
\csvset{
...
%\input{NearTerm_2024-09-03-2030_noMWC/NearTerm_2024-09-03-2030_noMWC.tex}
\begin{document}
...
\end{figure} 
 ...
 The parameters are stored in \href{https://github.com/DUNE/CCB-data/blob/CCB-Jun24/model-2024/NearTerm_2024-09-03-2040.json}{NearTerm\_2024-09-03-2040.json} and  \href{https://github.com/DUNE/CCB-data/blob/CCB-Jun24/model-2024/NearTerm_2024-09-03-2040_timeline.csv}{NearTerm\_2024-09-03-2040\_timeline.csv}
 
The calculation starts with numbers of events from the timeline\footnote{Event numbers for previous years are back-estimated from the total size of the data from the data catalog and an estimated size/event because the catalog does not report event number totals.  Early simulation stored very large events relative to the current estimated size, leading to an overestimate of the number of events but a correct estimate of disk and tape use.}  and uses those numbers, with CPU/storage times/event from Table \ref{tab:DetectorProcessingParameters} to calculate the annual new storage and CPU use for data taken in that year.  Figure/Tables \ref{tab:DataEventsPerYear} and \ref{tab:SimEventsPerYear} show the assumptions for numbers of events/year. 

{\input NearTerm_2024-09-03-2030_noMWC/Millions-of-Physics-Events-per-Year-by-Detector-Events.tex
}

{\input NearTerm_2024-09-03-2030_noMWC/Millions-of-Reconstructed-Simulated-Events-per-Year-by-Detector-Events.tex
}
...
\centering
\footnotesize
\csvautotabularright{NearTerm_2024-09-03-2030_noMWC/NearTerm_2024-09-03-2040_detectors.csv}
...
\centering
\footnotesize
\csvautotabularright{NearTerm_2024-09-03-2030_noMWC/NearTerm_2024-09-03-2040_diskcopies.csv}
\caption{Lifetimes and number of copies for different kinds of data. An exception: to accommodate fast analysis of the the PDHD and PDVD runs, two copies of raw data from those runs are kept while the simulation and reconstruction from the original PD runs are reduced to only one copy. }
\label{tab:Lifetimes}
\end{table}
...
Figure/Table \ref{tab:CPU-kHS23-Yr-Types}. shows CPU usage by data type.

%\input NearTerm_2024-09-03-2030_noMWC/Processing-by-Type-CPU-kHS23-Yr.tex
...
\centering
\footnotesize
\csvautotabularright{NearTerm_2024-09-03-2030_noMWC/NearTerm_2024-09-03-2040_splits_Disk.csv}
...
\centering
\footnotesize
\csvautotabularright{NearTerm_2024-09-03-2030_noMWC/NearTerm_2024-09-03-2040_splits_Tape.csv}
...
\centering
\footnotesize
\csvautotabularright{NearTerm_2024-09-03-2030_noMWC/NearTerm_2024-09-03-2040_splits_CPU.csv}
...
\input NearTerm_2024-09-03-2030_noMWC/Cumulative-Disk-by-Detector-Storage.tex
\input NearTerm_2024-09-03-2030_noMWC/Cumulative-Disk-by-Type-Storage.tex
\input NearTerm_2024-09-03-2030_noMWC/Cumulative-Disk-by-Site-Storage.tex

\input NearTerm_2024-09-03-2030_noMWC/Cumulative-Tape-by-Detector-Storage.tex
\input NearTerm_2024-09-03-2030_noMWC/Cumulative-Tape-by-Type-Storage.tex
\input NearTerm_2024-09-03-2030_noMWC/Cumulative-Tape-by-Site-Storage.tex


\input NearTerm_2024-09-03-2030_noMWC/Processing-by-Detector-CPU-kHS23-Yr.tex
\input NearTerm_2024-09-03-2030_noMWC/Processing-by-Type-CPU-kHS23-Yr.tex
\input NearTerm_2024-09-03-2030_noMWC/CPU-processing-by-Site-CPU-kHS23-Yr.tex
...
{\input NearTerm_2024-09-03-2038_noMWC/Millions-of-Physics-Events-per-Year-by-Detector-Events.tex
}

{\input NearTerm_2024-09-03-2038_noMWC/Millions-of-Reconstructed-Simulated-Events-per-Year-by-Detector-Events.tex
}


\input NearTerm_2024-09-03-2038_noMWC/Cumulative-Disk-by-Detector-Storage.tex
\input NearTerm_2024-09-03-2038_noMWC/Cumulative-Disk-by-Type-Storage.tex
\input NearTerm_2024-09-03-2038_noMWC/Cumulative-Disk-by-Site-Storage.tex

\input NearTerm_2024-09-03-2038_noMWC/Cumulative-Tape-by-Detector-Storage.tex
\input NearTerm_2024-09-03-2038_noMWC/Cumulative-Tape-by-Type-Storage.tex
\input NearTerm_2024-09-03-2038_noMWC/Cumulative-Tape-by-Site-Storage.tex


\input NearTerm_2024-09-03-2038_noMWC/Processing-by-Detector-CPU-kHS23-Yr.tex
\input NearTerm_2024-09-03-2038_noMWC/Processing-by-Type-CPU-kHS23-Yr.tex
\input NearTerm_2024-09-03-2038_noMWC/CPU-processing-by-Site-CPU-kHS23-Yr.tex
