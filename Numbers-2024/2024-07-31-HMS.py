...
# for det in Detectors:
#     if DEBUG: print ("Raw-Events",det,Inputs[det]["Raw-Events"])
...
#             Inputs[det][key] = cumulateMap(Years,Inputs[det]["Raw-Events"],Reprocess[det])
#             for year in Years:
...
#                 if DEBUG:print (year,float(Inputs[det]["Raw-Events"][year]),(config[det][key]))
                
#                 Inputs[det][key][year] = float(Inputs[det]["Raw-Events"][year])*config[det][key]
#             continue
