...
\begin{itemize}
\item A later start for ProtoDUNE-2 running at CERN. This leads to a spike in needs for storage/CPU in mid 2024.  As this was anticipated for 2023, there is little change in the request. 
...
\begin{figure}[h]
\centering\includegraphics[height=0.4\textwidth]{NearTerm_2024-02-02-2030_noMWC/NearTerm_2024-02-02-2030_noMWC-Cores.png}
\csvautotabularright{NearTerm_2024-02-02-2030_noMWC/NearTerm_2024-02-02-2030_noMWC-Cores.csv}  %had to fix so moved to external
