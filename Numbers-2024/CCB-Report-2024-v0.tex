...
\begin{figure}[h]
\centering\includegraphics[height=0.5\textwidth]{NearTerm_2024-02-01-2030_noMWC/NearTerm_2024-02-01-2030_noMWC-Cumulative-Disk.png}
\csvautotabularright{NearTerm_2024-02-01-2030_noMWC/NearTerm_2024-02-01-2030_noMWC-Cumulative-Disk-Source.csv}
\csvautotabularright{NearTerm_2024-02-01-2030_noMWC/NearTerm_2024-02-01-2030_noMWC-Cumulative-Disk-Request.csv}
...
Figure  \ref{fig:Cumulative-Tape}  summarizes the cumulative  tape need projected by our model. These numbers are used to generate the requests for 2023.  They are divided into the two host laboratories (CERN and FNAL) and Global, which includes contributions from the rest of the collaboration, including OSG, BNL and NERSC in the US. 
...
\begin{figure}[h]
\centering\includegraphics[height=0.4\textwidth]{NearTerm_2024-02-01-2030_noMWC/NearTerm_2024-02-01-2030_noMWC-Cumulative-Tape.png}

\csvautotabularright{NearTerm_2024-02-01-2030_noMWC/NearTerm_2024-02-01-2030_noMWC-Cumulative-Tape-Source.csv}
%\csvautotabularright{external/NearTerm_2024-02-01-2030_noMWC-Cumulative-Tape-Request.csv}
...
\begin{figure}[h]
\centering\includegraphics[height=0.4\textwidth]{NearTerm_2024-02-01-2030_noMWC/NearTerm_2024-02-01-2030_noMWC-Cores.png}
\csvautotabularright{NearTerm_2024-02-01-2030_noMWC/NearTerm_2024-02-01-2030_noMWC-Cores.csv}  %had to fix so moved to external
\caption{Proposed wall-time needs in number of 2000 MB cores (MWC-years). Memory-weighted  wall-time takes into account memory and efficiency.}\label{fig:CoresMain}
\end{figure}

\begin{figure}[h]
\centering\includegraphics[height=0.4\textwidth]{NearTerm_2024-02-01-2030_noMWC/NearTerm_2024-02-01-2030_noMWC-HS23.png}
\csvautotabularright{NearTerm_2024-02-01-2030_noMWC/NearTerm_2024-02-01-2030_noMWC-HS23.csv}  %had to fix so moved to external
...
%\section{
%\input{NearTerm_2024-02-01-2030_noMWC.tex}
...
\input{NearTerm_2024-02-01-2030_noMWC/tables.tex}
\end{document}
