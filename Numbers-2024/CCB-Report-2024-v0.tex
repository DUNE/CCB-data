...
\begin{figure}[h]
\centering\includegraphics[height=0.5\textwidth]{NearTerm_2024-01-22-2030_noMWC/NearTerm_2024-01-22-2030_noMWC-Cumulative-Disk.png}
\csvautotabularright{NearTerm_2024-01-22-2030_noMWC/NearTerm_2024-01-22-2030_noMWC-Cumulative-Disk-Source.csv}
\csvautotabularright{NearTerm_2024-01-22-2030_noMWC/NearTerm_2024-01-22-2030_noMWC-Cumulative-Disk-Request.csv}
...
\begin{table}[ht]
\centering\csvautotabularright{external/DiskResources-2021-2022-2023-Detail-update.csv}
...
\begin{figure}[h]
\centering\includegraphics[height=0.4\textwidth]{NearTerm_2024-01-22-2030_noMWC/NearTerm_2024-01-22-2030_noMWC-Cumulative-Tape.png}

\csvautotabularright{NearTerm_2024-01-22-2030_noMWC/NearTerm_2024-01-22-2030_noMWC-Cumulative-Tape-Source.csv}
...
\csvautotabularright{MoreSim_2022-12-04-2026//MoreSim_2022-12-04-2026-Cores.csv}  %had to fix so moved to external
...
%\section{
%\input{NearTerm_2024-01-22-2030_noMWC.tex}
...
\input{MoreSim_2022-12-04-2026/tables.tex}
\end{document}
