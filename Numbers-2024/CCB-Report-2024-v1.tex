...
\input{NearTerm_2024-02-05-2030_noMWC/NearTerm_2024-02-05-2030_noMWC_macros}
\begin{document}
...
{\bf CPU} &&&&\\
  ...
  \hline
   \end{tabular}
  \caption{Proposed division between FNAL/CERN/Global for storage and CPU until 2029.  The tape division is not yet finalized as we work on integration of Global tape archives. In the long run, Global sites are expected to take over some of the tape provision currently provided by CERN. }
...
The total request for 2024 is \DISKTotal PB.  This is consistent with the current allocated space of 23.6 PB. Because 5-10\% headroom is needed, we request that the current allocated  23.6 PB be retained for 2024. 
