...
\hline
 	&&	Disk (PB)	&	Modified Disk (PB)	&	Tape(PB)	&	CPU (MWC)	\\
	\hline
{\bf Model}	&&	25.80	&	25.80	&	45.60	&	12765.00	\\
\hline
{\bf Request}	&&		&		&		&		\\
...
\caption{Proposed pledges for 2023.  Disk pledges are based on existing CERN and FNAL contributions with National contributions making up the rest of the model request.  Tape pledges reflect the dominant use of CERN and FNAL for archival storage of data.  CPU pledges assume Fermilab and CERN each pledge 25\%.   }
\end{centering}
