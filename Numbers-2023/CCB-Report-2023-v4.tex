...
%\SetWatermarkScale{5}
\title{DUNE Offline Computing Model Calculations for 2023-revised}
\author{H. Schellman for the Computing Consortium}
\date{December 9, 2022 -- version 4}
...
Version 4 has minor updates to the model which were presented at the meeting.
