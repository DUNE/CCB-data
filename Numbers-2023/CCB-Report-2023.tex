...
\csvautotabularright{Parameters_2022-11-21-2026/Parameters_2022-11-21-2026-Cumulative-Disk.csv}\caption{Cumulative Disk needs in PB. Includes data lifetimes}\label{fig:Cumulative-Disk}
\end{figure}
...
\csvautotabularright{Parameters_2022-11-21-2026/Parameters_2022-11-21-2026-Cumulative-Tape.csv}\caption{Cumulative Tape needs in PB. Includes data lifetimes}\label{fig:Cumulative-Tape}
\end{figure}
...
\csvautotabularright{Parameters_2022-11-21-2026/Parameters_2022-11-21-2026-Cores.csv}
...
%\section{
%\input{Parameters_2022-11-21-2026.tex}
...
\input{Parameters_2022-11-21-2026/tables.tex}
\end{document}
