...
\input{NearTerm_2025-12-10-2030_noMWC/NearTerm_2025-12-10-2040macros.tex}
%\input{NearTerm_2025-12-10-2035_noMWC/NearTerm_2025-12-10-2040macros.tex}
\makeatletter
\csvset{
...
%\SetWatermarkText{One Copy}
%\SetWatermarkScale{5}

\title{DUNE Offline Computing Model Calculations for 2026}
\author{K. Herner, M. Kirby, and H. Schellman for the Computing Consortium}
\date{\today\ -- version 6.0 }



\newcommand{\hrefII}[1]{\href{#1}{#1}}

%\input{NearTerm_2025-12-10-2035_noMWC/NearTerm_2025-12-10-2035_noMWC.tex}
\begin{document}
...
This is a projection for DUNE CPU and storage needs intended for use at the Computing Contributions Board meeting in December 2025. It projects needs for \configRequestYear\ to \configMaxYear. 

The overall computing model  and 2023 projections for DUNE were described in chapters 6-13 of the  (Oct. 2022) DUNE Conceptual Design Report \cite{DUNE:2022fcw}.   This document provides updates on resource needs for \configRequestYear\ - \configMaxYear. 

The \configRequestYear\ projection is done using codes at: \href{https://github.com/DUNE/CCB-data/tree/kherner\_Oct2025/model-2025/}{https://github.com/DUNE/CCB-data/tree/kherner\_Oct2025/model-2025/} from parameters stored in a json and csv file. We use CPU and storage sizes derived from ProtoDUNE, 2x2 Demonstrator, and simulation experience and apply them to projected numbers of events from the various DUNE detectors. 
...
Changes since the last report \cite{CCB2025, CCB2024Report, CCB2024Minutes} include:

\begin{itemize}
\item An update on the rewrite of the model code to make it more robust and allow more flexibility in plots. 
\item Change to the Far Detector, Near Detector, and Beam operations schedule based upon presentations at the most recent \href{https://indico.fnal.gov/event/70787/}{LBNC} and \href{https://indico.fnal.gov/event/71286/}{RRB}.
\item Delay and subsequent extension of the start of ProtoDUNE-VD running at CERN to take place between 2024-2026. This increased and extended the need for storage/CPU into mid 2027.  
\item More data from both ProtoDUNE-HD and ProtoDUNE-VD than originally projected because of additional cosmic-ray operations and enhanced performance of the DAQ.
...
See Figures  \ref{tab:CumulativeDiskByDetector2025-2030}, \ref{tab:CumulativeDiskByType2025-2030}, \ref{tab:CumulativeDiskBySite2025-2030} for projections.  }
\item This report now uses existing data catalog information up to December 2025 in forming a baseline for future projections. 
\item Switch to HS23-Years as opposed to Core-Years as the main CPU reporting system.
\item Revisions to near-term requests based on the 2025 experience including the possibility of tape requests from institutions other than FNAL and CERN.
...
\begin{centering}
  \begin{tabular}{|l|l|l|}
    ...
    Coldbox & Both VD and HD & 2018-2026\\
    PDHD & ProtoDUNE-2 Horizonal Drift & 2023-2025\\
    PDVD & ProtoDUNE-2 Vertical Drift & 2024-2026\\
    2x2& Prototype NDLAr Detector & 2024-2026\\
    HD & Far Detector Horizontal Drift & 2030-\\
    VD & Far Detector Vertical Drift & 2029-\\
    NDLAr + TMS & Near Detector Liquid Argon + Muon System & 2032-\\
    SAND & On Axis Near Detector & 2032- \\
     \hline
     \end{tabular}
...
The model currently does not include any disk headroom allowance for data movement.  This will be added in the 2026 version of the model. 
...
We assume ProtoDUNE running in 2024-2026 with startup of DUNE FDVD commissioning in 2027 (Test stream) and data taking in late 2029. A cap of 30 PB/year for raw data (Events, Trigger Primitives and Tests) is imposed by scaling all categories down proportionally when 30 PB is reached. DUNE FDHD commissioning begins in 2028 and data taking starts in 2030.
...
\end{figure} 
 ...
 The parameters are stored in \href{https://github.com/DUNE/CCB-data/blob/kherner_Oct2025/model-2025/NearTerm_2025-12-10-2040.json}{NearTerm\_2024-12-10-2040.json} and  \href{https://github.com/DUNE/CCB-data/blob/kherner_Oct2025/model-2025/NearTerm_2025-12-10-2040_timeline.csv}{NearTerm\_2025-12-10-2040\_timeline.csv}
 
The calculation starts with numbers of events from the timeline\footnote{Event numbers for previous years are back-estimated from the total size of the data from the data catalog and an estimated size/event because the catalog does not report event number totals.  Early simulation stored very large events relative to the current estimated size, leading to an overestimate of the number of events but a correct estimate of disk and tape use.}  and uses those numbers, with CPU/storage times/event from Table \ref{tab:DetectorProcessingParameters} to calculate the annual new storage and CPU use for data taken in that year.  Figure/Tables \ref{tab:DataEventsPerYear2025-2030} and \ref{tab:SimEventsPerYear2025-2030} show the assumptions for numbers of events/year. 

{\input NearTerm_2025-12-10-2030_noMWC/Millions-of-Physics-Events-per-Year-by-Detector-Events.tex
}

{\input NearTerm_2025-12-10-2030_noMWC/Millions-of-Reconstructed-Simulated-Events-per-Year-by-Detector-Events.tex
}
...
\centering
\footnotesize
\csvautotabularright{NearTerm_2025-12-10-2030_noMWC/NearTerm_2025-12-10-2040_detectors.csv}
...
\centering
\footnotesize
\csvautotabularright{NearTerm_2025-12-10-2030_noMWC/NearTerm_2025-12-10-2040_diskcopies.csv}
...
Figure/Table \ref{tab:CPU-kHS23-Yr-Types2025-2030} and \ref{tab:DataEventsPerYear2025-2030}. shows CPU usage by data type.

\input NearTerm_2025-12-10-2030_noMWC/Processing-by-Type-CPU-kHS23-Yr.tex
...
\centering
\footnotesize
\csvautotabularright{NearTerm_2025-12-10-2030_noMWC/NearTerm_2025-12-10-2040_splits_Disk.csv}
...
\centering
\footnotesize
\csvautotabularright{NearTerm_2025-12-10-2030_noMWC/NearTerm_2025-12-10-2040_splits_Tape.csv}
